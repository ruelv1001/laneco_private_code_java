...
public class Consumer extends com.generic.readandbill.database.Consumer{
	 private boolean SCSwitch;
	    ...
	    public Consumer() {
	        ...
	        //this.totalDsm = 0.0d;
	        this.tracTax = 0.0d;
	        this.rptprevTax = 0.0d;
	        this.localFranchiseTax = 0.0d;
	    ...
	    public double getArrears() {
	        ...
	        return result;
	        //return result + (arrears + (0.12 * serviceFee));
	        //return result + (serviceFee + (0.12d * serviceFee));
	    ...
	    //public double gettotalDsm() {
	    //	return totalDsm;
	    //}
	    
	    //public void settotalDsm(double totalDsm) {
	    //	this.totalDsm = totalDsm;
	    //}
	    
	    public double getdaaRefund() {
	    	if (daaRefund == 0.0d) {
	            return 0.0d;
	        }
	        	return daaRefund;
	    }
	        public void setdaaRefund(double daaRefund) {
		        this.daaRefund = daaRefund;
		    }	    
	    
	    public double gettracTax() {
	    	return tracTax;
	    }
	    
	    public void settracTax(double tracTax) {
	    	this.tracTax = tracTax;
	    }
	    
	    public double getrptprevTax() {
	    	return rptprevTax;
	    }
	    
	    public void setrptprevTax(double rptprevTax) {
	    	this.rptprevTax = rptprevTax;
	    }
	    
	    public double getlocalFranchiseTax() {
	    	return localFranchiseTax;
	    }
	    
	    public void setlocalFranchiseTax(double localFranchiseTax) {
	    	this.localFranchiseTax = localFranchiseTax;
	    }
