...
public class ConsumerDataSource extends com.generic.readandbill.database.ConsumerDataSource {
	 public static final String ARMATS = "armats";
	    ...
	    public static final String DAAREFUND = "daarefund";
	    public static final String TRACTAX = "tracTax";
	    public static final String LOCAL_FRANCHISE_TAX = "localFranchiseTax";
	    // public static final String BUSINESSTAX = "businessTax";
	    public static final String RPTPREVTAX = "rptprevTax";
	    ...
	    public static List<String> consumerFields() {
	        ...
	        consumerFields.add("daarefund real not null, ");
	        consumerFields.add("tracTax real not null, ");
	        consumerFields.add("localFranchiseTax real not null, ");
	        // consumerFields.add("businessTax real not null");
	        consumerFields.add("rptprevTax real not null, ");
	    ...
	    public ConsumerDataSource(Context context) {
	        ...
	        this.lAllColumn = new String[]{DEMAND_MULTIPLIER, DAAREFUND, DEMAND_MIN, DEMAND_MAX, METERBRAND, AVEKWH, DATEENERGIZED, TRANSFORMERNUMBER, POLENUMBER, CORELOSS, TRANSFORMERLOSTTESTRESULT, ARMATS, ARREARS, CHANGE_METER_KWHR, DIFFERENTIAL_BILL_RECOVERY, SENIORCITIZEN_DISCOUNT, SCAP, REFUND, HELP, PILFER, NUMBER_OF_ARREARS, KW, DEMANDCHARGE, DISCO, INCENTIVES, MATERIAL, EQUIPTMENT, OTHERSSURCHARGE, TRACTAX, LOCAL_FRANCHISE_TAX, RPTPREVTAX};
	    ...
	    protected ContentValues consumerContentValues(Consumer consumer) {
	        ...
	        values.put(DAAREFUND, Double.valueOf(consumer.getdaaRefund()));
	        values.put(TRACTAX, Double.valueOf(consumer.gettracTax()));
	        values.put(LOCAL_FRANCHISE_TAX, Double.valueOf(consumer.getlocalFranchiseTax()));
	        // values.put(BUSINESSTAX, Double.valueOf(consumer.getbusinessTax()));
	        values.put(RPTPREVTAX, Double.valueOf(consumer.getrptprevTax()));
	    ...
	    protected Consumer cursorToConsumer(Cursor cursor) {
	        ...
	        consumer.setEquiptment(cursor.getDouble(cursor.getColumnIndex(EQUIPTMENT)));
	        consumer.setOthersSurcharge(cursor.getDouble(cursor.getColumnIndex(OTHERSSURCHARGE)));
	        consumer.setdaaRefund(cursor.getDouble(cursor.getColumnIndex(DAAREFUND)));
	        consumer.settracTax(cursor.getDouble(cursor.getColumnIndex(TRACTAX)));
	        consumer.setlocalFranchiseTax(cursor.getDouble(cursor.getColumnIndex(LOCAL_FRANCHISE_TAX)));
	        // consumer.setbusinessTax(cursor.getColumnIndex(BUSINESSTAX));
	        consumer.setrptprevTax(cursor.getDouble(cursor.getColumnIndex(RPTPREVTAX)));
